  ...
  <div class="company_list">
    ...
    >
      ...
      <el-table-column
        ...
        show-overflow-tooltip
      />
      <el-table-column prop="money" label="费用余额" show-overflow-tooltip />
      <el-table-column prop="business" label="营业执照">
      ...
      <el-table-column width="350px" prop="handle" label="操作">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            >编辑</el-button
          >
          <el-button type="text" @click="handle(3, scope.row)"
            >账户充值</el-button
          >
          <el-button
            type="text"
            @click="handle(4, scope.row)"
            v-show="isHasAuth(178)"
            >扣费记录</el-button
          >
          <el-button
            type="text"
    ...
    <el-dialog title="余额充值" :visible.sync="dialogVisible" width="40%">
