        ...
        <div class="search_top">
          <el-form :inline="true" :model="formInline" class="left">
            ...
            <el-form-item label="社保状态:" prop="is_stop">
              <el-select v-model="formInline.is_stop" placeholder="请选择" @change="search(0)">
      ...
      <el-tab-pane  label="社保补偿名单" name="1">
        <div class="search_top">
          <el-form :inline="true" :model="formInline2" class="left">
            <el-form-item label="姓名:" prop="username">
              <el-input v-model="formInline2.username" placeholder="请输入姓名" @keyup.enter.native="search(1)"></el-input>
            </el-form-item>
...
<script>
import { getSocialList, addCompanySocial, stop, remarkSocial, editPersonSocial, getSocialInfo, getSocialCompensate } from '@/api/social_insurance.js'
