<template>
  <div class="company_list">
    ...
    >
      ...
      <el-table-column prop="contact_mail" label="邮箱" />
      <el-table-column prop="role_name" label="角色类型" />
        ...
        if (res.code) {
          ...
          setTimeout(() => {
            this.$refs.tree.setCheckedKeys(
              this.dialogTitle == "新增用户" ? [] : selected
            );
          }, 300);
        }
      });
